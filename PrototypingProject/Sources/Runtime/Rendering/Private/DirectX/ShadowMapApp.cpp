...
void ShadowMapApp::LoadTextures()
{
    ...
    {
		L"E:/Main/PEngine/PrototypingProject/Sources/Runtime/Rendering/Textures/bricks2.dds",
		L"E:/Main/PEngine/PrototypingProject/Sources/Runtime/Rendering/Textures/bricks2_nmap.dds",
		L"E:/Main/PEngine/PrototypingProject/Sources/Runtime/Rendering/Textures/tile.dds",
		L"E:/Main/PEngine/PrototypingProject/Sources/Runtime/Rendering/Textures/tile_nmap.dds",
		L"E:/Main/PEngine/PrototypingProject/Sources/Runtime/Rendering/Textures/white1x1.dds",
		L"E:/Main/PEngine/PrototypingProject/Sources/Runtime/Rendering/Textures/default_nmap.dds",
		L"E:/Main/PEngine/PrototypingProject/Sources/Runtime/Rendering/Textures/desertcube1024.dds"
    };
...
void ShadowMapApp::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"E:\\Main\\PEngine\\PrototypingProject\\Sources\\Runtime\\Rendering\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"E:\\Main\\PEngine\\PrototypingProject\\Sources\\Runtime\\Rendering\\Shaders\\Default.hlsl", nullptr, "PS", "ps_5_1");

    mShaders["shadowVS"] = d3dUtil::CompileShader(L"E:\\Main\\PEngine\\PrototypingProject\\Sources\\Runtime\\Rendering\\Shaders\\Shadows.hlsl", nullptr, "VS", "vs_5_1");
    mShaders["shadowOpaquePS"] = d3dUtil::CompileShader(L"E:\\Main\\PEngine\\PrototypingProject\\Sources\\Runtime\\Rendering\\Shaders\\Shadows.hlsl", nullptr, "PS", "ps_5_1");
    mShaders["shadowAlphaTestedPS"] = d3dUtil::CompileShader(L"E:\\Main\\PEngine\\PrototypingProject\\Sources\\Runtime\\Rendering\\Shaders\\Shadows.hlsl", alphaTestDefines, "PS", "ps_5_1");
	
    mShaders["debugVS"] = d3dUtil::CompileShader(L"E:\\Main\\PEngine\\PrototypingProject\\Sources\\Runtime\\Rendering\\Shaders\\ShadowDebug.hlsl", nullptr, "VS", "vs_5_1");
    mShaders["debugPS"] = d3dUtil::CompileShader(L"E:\\Main\\PEngine\\PrototypingProject\\Sources\\Runtime\\Rendering\\Shaders\\ShadowDebug.hlsl", nullptr, "PS", "ps_5_1");

	mShaders["skyVS"] = d3dUtil::CompileShader(L"E:\\Main\\PEngine\\PrototypingProject\\Sources\\Runtime\\Rendering\\Shaders\\Sky.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["skyPS"] = d3dUtil::CompileShader(L"E:\\Main\\PEngine\\PrototypingProject\\Sources\\Runtime\\Rendering\\Shaders\\Sky.hlsl", nullptr, "PS", "ps_5_1");
...
{
    std::ifstream fin("E:\\Main\\PEngine\\PrototypingProject\\Sources\\Runtime\\Rendering\\Models\\skull.txt");

    if (!fin)
    {
        MessageBox(0, L"E:\\Main\\PEngine\\PrototypingProject\\Sources\\Runtime\\Rendering\\Models\\skull.txt not found.", 0, 0);
        return;
    }
